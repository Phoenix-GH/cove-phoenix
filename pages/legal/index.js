...
export default class LegalPage extends Component {
  ...
  handleAnimatedScroll = (e, to = 0, duration = 1250) => {
  ...
  handleCustomScroll = (toElementId) => {
    const distance = document.querySelector(toElementId).offsetTop - 100;
    this.handleAnimatedScroll(null, distance);
  }
    ...
    return (
      <Layout>
        ...
        <Container>
          ...
          <h2 className="legal__section-link" onClick={() => this.handleCustomScroll('#termsOfUse')}>Terms of Use</h2>
          <h2 className="legal__section-link" onClick={() => this.handleCustomScroll('#privacyPolicy')}>Privacy Policy</h2>
          <div id="termsOfSale" className="legal">
            <button className={`legal__scroll-top ${this.state.scrollActiveClass}`} onClick={this.handleAnimatedScroll} />
            <h1>
            ...
            <p>
                ...
                herein. The Cove Privacy Policy found at <a href="http://www.covesmart.com/privacypolicy">www.covesmart.com/privacypolicy </a>
            ...
            <p>
                ...
                OF SALE BY ACCESSING THEM AT <a href="http://WWW.COVESMART.COM/MYACCOUNT">WWW.COVESMART.COM/TERMSOFSALE </a>
            ...
            <p>
                ...
                change your Payment Due Date at <a href="http://www.covesmart.com/myaccount">www.covesmart.com/myaccount </a>
            ...
            <ol type="a">
              <li>
                ...
                completing the required information at <a href="http://www.covesmart.com/myaccount">www.covesmart.com/myaccount </a>
              ...
              <li>
                ...
                within one-year of purchase at <a href="http://www.covesmart.com/myaccount">www.covesmart.com/myaccount</a>.
                </p>
              </li>
              <li>
                <p>
            ...
            described below). Details about the Premier Membership Plan can be found at <a href="http://www.covesmart.com/membership">www.covesmart.com/membership</a>. The
            ...
            <ol type="a">
              ...
              <li>
                ...
                customer portal at <a href="http://www.covesmart.com/myaccount">www.covesmart.com/myaccount </a>
            ...
            updated of any changes by notifying Cove in writing by emailing    <a href="mailto:support@covesmart.com">support@covesmart.com</a> or by
                making changes using your customer portal at <a href="http://www.covesmart.com/myaccount">www.covesmart.com/myaccount</a>;
            ...
            <ol type="a">
              <li>
                ...
                your customer portal at <a href="http://www.covesmart.com/myaccount">www.covesmart.com/myaccount</a>
                .
                </p>
              </li>
              <li>
            ...
            <p>
                ...
                PERMISSION TO DO SO. Please refer to Cove’s Privacy Policy at <a href="http://www.covesmart.com/privacypolicy"> www.covesmart.com/privacypolicy </a>
            ...
            {/* TERMS OF USE */}
            <p>
              <h1 id="termsOfUse">COVE TERMS OF USE</h1>
            </p>
            <p>
              <strong>Last Updated: 4/16/2018</strong>
            </p>
            ...
            <p>
              These terms of use are entered into by and between you and Cove Smart, LLC
              (“Cove”, “we”, “our”, “us”). The following terms and conditions, together
              with any documents, agreements or policies of Cove, including but not
              limited to Cove’s Terms and Conditions of Sale of Products and Services
              (Cove’s “Terms of Sale”) and its Privacy Policy, which are expressly
              incorporated herein by this reference (collectively, these "Terms of Use"),
              govern your access to and use of Cove’s website(s), including <a href="http://www.covesmart.com">www.covesmart.com</a>, and mobile
              ...
              applications whether now existing or later developed, and your use of such
              mobile applications, websites, domains and sub-domains (collectively the
              “Sites”), however accessed and/or used by you, including any content or
              functionality on or through the Sites. The term “you”, as used in these
              Terms of Use, means any individual or entity who accesses or uses the
              Sites. Capitalized terms used in these Terms of Use shall have the meanings
              identified in the Terms of Sale and are incorporated herein.
            </p>
            <p>
                <strong>
                    PLEASE READ THESE TERMS OF USE CAREFULLY BEFORE YOU START TO USE THE
                    SITES. BY USING THE SITES, YOU ACCEPT AND AGREE TO BE BOUND AND ABIDE
                    BY THESE TERMS OF USE AND OUR PRIVACY POLICY, FOUND AT
                </strong><a href="http://www.covesmart.com/privacypolicy">
                    <strong> WWW.COVESMART.COM/PRIVACYPOLICY</strong>
                </a>
                <strong>
                    , INCORPORATED HEREIN BY THIS REFERENCE. IF YOU DO NOT WANT TO AGREE TO
                    THESE TERMS OF USE OR THE PRIVACY POLICY, YOU MUST NOT ACCESS OR USE
                    THE SITES.
                </strong>
            </p>
            <p>
                The Sites are offered and available to users who are 18 years of age or
                older. By using the Sites, you represent and warrant that you meet the
                foregoing eligibility requirements. If you are under the age of 18, you may
                only use the Sites under the supervision of your parents or guardians. If
                you do not have adult supervision, you must not access or use the Sites.
                Moreover, the Products and Services featured on the Sites are available
                only in the United States. You agree not to use or attempt to use any Cove
                Product or Service from outside of the United States or for any illegal or
                unlawful purpose.
            </p>
            <p>
                For the avoidance of doubt, the Terms of Sale and your Retail Installment
                Agreement, if applicable, govern your purchase, subscription, and use of
                any Products or Services you have elected to receive from Cove, including
                information in your customer account and management of said account,
                through Cove’s Sites. These Terms of Use are in addition to any such terms
                that may apply to you. Any conflicts between these Terms of Use and the
                Terms of Sale or a Retail Installment Agreement, if applicable, shall be
                superseded and governed by the Terms of Sale and/or your Retail Installment
                Agreement, if applicable.
                <strong>
                    Any claims and disputes arising under the Terms of Sale or a Retail
                    Installment Agreement, if applicable, shall be subject solely to terms
                    contained therein and not these Terms of Use
                </strong>
                .
            </p>
            <p>
                <strong>I. </strong>
                <strong>CHANGES TO THE TERMS OF USE AND SITES</strong>
            </p>
            <p>
                <strong></strong>
            </p>
            <p>
                Cove may revise and update these Terms of Use from time to time in its sole
                discretion. All changes are effective immediately when posted by Cove, and
                apply to all access to and use of the Sites thereafter. Your continued
                access or use of the Sites following the posting of revised Terms of Use
                means that you accept and agree to the changes. However, any changes to the
                dispute resolution provisions set forth in Governing Law and Jurisdiction
                will not apply to any disputes for which the parties have actual notice
                prior to the date the change is posted on the Sites. In addition, we may
                update the content on the Sites from time to time, but the content on the
                Sites is not necessarily complete or up to date. Any of the material on the
                Sites may be out of date at any given time, and we are under no obligation
                to update such material.<strong></strong>
            </p>
            <p>
                <strong></strong>
            </p>
            <p>
                <strong>II. </strong>
                <strong>ACCESSING THE SITES</strong>
            </p>
            <p>
                We reserve the right to withdraw or amend the Sites, and any Service,
                information or material we provide on the Sites, in our sole discretion
                without notice. We will not be liable if for any reason all or any part of
                the Sites is unavailable at any time or for any period.
            </p>
            <p>
                <strong>III. </strong>
            ...
            <p>
                The Sites and their entire contents, features and functionality (including
                ...
                Cove, or other providers of such material, and are protected by United
                States and international copyright, trademark, patent, trade secret and
                other intellectual property or proprietary rights laws.
            </p>
            <p>
                These Terms of Use permit you to use the Sites for your personal,
                non-commercial use only. You must not reproduce, distribute, modify, create
                derivative works of, publicly display or perform, republish, download,
                store, or transmit any of the material on Cove’s Sites except for your
                personal use without the prior written permission of Cove. If Cove provides
                social media features, buttons or links, from or to Facebook, Twitter,
                Pinterest, Instagram, YouTube, or other social media sites, you may link to
                or take such actions that are enabled by such social media features.
            </p>
            <p>
                You must not:
            </p>
            <ul>
              ...
              <li>
                  ...
                  graphics separately from the accompanying text as they appear on the Sites.
              </li>
              <li>
                  Delete or alter any copyright, trademark or other proprietary rights
                  notices from copies of materials from the Sites.
              </li>
            </ul>
            <p>
                No right, title or interest in or to the Sites or any content on the Sites
                is transferred to you under any circumstances, and all rights not expressly
                granted are reserved by Cove. Any use of the Sites not expressly permitted
            ...
            <p>
                Cove’s logos, all related names, logos, Product and Service names, trade
                dress, marks, and its designs and slogans are trademarks of Cove or its
                affiliates or service providers (collectively, the “Marks”). You must not
                use the Marks without the prior written permission of Cove. All other
                names, logos, product and service names, trade dress, marks, and designs
                and slogans on the Sites are the trademarks of their respective owners.
            </p>
            <p>
              <strong>V. </strong>
            ...
            <p>
              You may use the Sites only for lawful purposes and in accordance with these
              Terms of Use. You agree NOT to use the Sites:
            </p>
            <ul>
              <li>
                In any way that violates any applicable federal, state, local or
                international law or regulation (including, without limitation, any laws
                regarding the export of data or software to and from the U.S.A. or other
                countries).
              </li>
              <li>
              ...
              <li>
                ...
                similar solicitation material or method.
              </li>
              <li>
                To impersonate or attempt to impersonate Cove, any Cove employee, another
                Cove customer, or other user of the Sites or any other individual or entity
                (including, without limitation, by using e-mail addresses or screen names
                associated with any of the foregoing).
              </li>
              <li>
                To engage in any other conduct that restricts or inhibits any other
                individual’s use or enjoyment of the Sites, or which, as determined by
                Cove, may harm Cove or users of the Sites or expose them to liability.
              </li>
            </ul>
            <p>
            ...
            <ul>
              <li>
                Use the Sites or any device, software or process or procedure in any
                manner that could disable, overburden, damage, or impair the proper working
                of the Sites or interfere with any other individual’s use of the Sites,
              ...
              <li>
                ...
                access the Sites for any purpose, including monitoring or copying any of
                the material on the Sites, including code used to create the Sites.
              </li>
              <li>
                Introduce any viruses, trojan horses, worms, logic bombs or other
                material which may be malicious or technologically harmful to the Sites or
                users thereof, including the obtaining of any Personal Identifiable
                Information (PII) of Cove’s customers or other users of the Sites.
              </li>
              <li>
                Attempt to gain unauthorized access to, interfere with, damage or disrupt
                any parts of the Sites, the server on which the Sites are stored or
                operate, or any server, computer or database connected to the Sites.
              </li>
              <li>
              ...
              <li>
                Otherwise attempt to interfere with the proper working and functionality
                of the Sites.
              </li>
            </ul>
            <p>
            ...
            <p>
              The Sites may contain message boards, chat rooms, surveys, personal web
              pages or profiles, forums, bulletin boards and other interactive features
              (collectively, "Interactive Services") that allow Cove’s customers or other
              users of the Sites to post, submit, publish, display or transmit
              (collectively, “post”) to other users or other individuals or entities
              content or materials (each, a “User Post” and collectively, "User Posts")
              on or through the Sites.
            </p>
            <p>
              All User Posts must comply with the Content Standards set out below in
              these Terms of Use.
            </p>
            <p>
              Any User Post you post to the Sites will be considered non-confidential and
              non-proprietary. By providing any User Post on the Sites, you grant Cove
              and its affiliates and service providers, and each of Cove’s and their
              respective successors and assigns the right to use, reproduce, modify,
              perform, display, distribute and otherwise disclose to third parties any
              material in your User Posts. You are fully responsible for any User Post
              that you submit or contribute to the Sites.
            </p>
            <p>
            ...
            <ul>
              <li>
                You own or control all rights in and to the User Posts you provide on the
                Sites and have the right to grant the license granted above.
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                Take any action with respect to any User Posts that Cove deems necessary
                or appropriate if Cove believes that such User Post violates these Terms of
                Use, including, but not limited to, the Content Standards (explained
                below), infringes any intellectual property right or other right of any
                individual or entity, threatens the personal safety of users of the Sites
                or the public, is illegal or could create liability for Cove.
              </li>
              <li>
                • Take appropriate legal action, including, without limitation, referral to
                law enforcement, for any illegal or unauthorized use of the Sites.
              </li>
            </ul>
            <p>
                Cove does not review all User Posts or other material before they are
                posted on the Sites, and cannot ensure prompt removal of objectionable User
                Posts or other material after it has been posted. Accordingly, Cove assumes
                no liability for any action or inaction regarding transmissions,
                communications or content provided by any user or third party, including
                User Posts. Cove has no liability or responsibility to anyone for
            ...
            <p>
                The following content standards apply to any and all User Posts, other
                materials posted to the Sites, and use of Cove’s Interactive Services on
                the Sites. User Posts must in their entirety comply with all applicable
                federal, state, local and international laws and regulations. Without
                limiting the foregoing, User Posts must not:
            </p>
            <ul>
              <li>
              ...
              <li>
                  ...
                  sexual orientation or identity, or age.
              </li>
              <li>
                  Infringe any patent, trademark, trade secret, copyright or other
                  intellectual property or other rights of any other individual or entity.
              </li>
              <li>
                  ...
                  criminal liability to you, Cove, and/or its affiliates, licensors or
                  service providers, under applicable laws or regulations or that otherwise
              ...
              <li>
                  ...
                  embarrass, alarm or annoy any other individual or entity.
              </li>
              <li>
                  Impersonate any individual or entity, or misrepresent your identity or
                  affiliation with any individual, entity, or organization.
              </li>
              <li>
                  Involve commercial activities or sales, such as contests, sweepstakes and
                  other sales promotions, bartering or advertising.
              </li>
              <li>
                  Give the impression that any User Posts emanates from or is endorsed by
                  Cove or any other individual or entity, if this is not the case.
              </li>
            </ul>
            <p>
                <strong>IX. </strong>
            ...
            <p>
                If you believe that any User Posts violate your copyright, please send to
                Cove a notice of the copyright infringement in accordance with the
                requirements of the U.S. Digital Millennium Copyright Act of 1998. It is
                the policy of Cove to terminate the customer or user accounts of repeat
                infringers. You may file a notification of such infringement with Cove’s
                Designated Agent as set forth below:
            </p>
            <ul>
              <li>
                Name of Agent Designated to Receive Notification of Claimed Infringement:
                Attention: Copyright Complaints
              </li>
              <li>
                Full Address of Designated Agent to Which Notification Should be Sent:
                P.O. Box 157, Orem, UT 84059
              </li>
              <li>
                E-Mail Address of Designated Agent: legal@covesmart.com
              </li>
            </ul>
            <p>
                Please see 17 U.S.C. §512(c)(3) for the requirements of a proper
                notification. Please note that the information provided in your
                notification, including any personal information contained therein, may be
                forwarded to the individual or entity who has provided the allegedly
                infringing content, and your sending to Cove such notification constitutes
                your consent to share this information with the alleged infringer.
            </p>
            <p>
                You should also note that if you make any material misrepresentation in
                your notification regarding whether the material or activity is infringing,
                you will be liable for all damages, including costs and attorneys' fees,
                incurred by Cove or the alleged infringer as the result of Cove relying
                upon such misrepresentation in removing or disabling access to the material
                or activity you claim to be infringing.
            </p>
            <p>
                We may give notice of a claim of copyright infringement to our users by
                means of a general notice on the Sites, an email to a customer’s or user's
                email address maintained in our records, or by written communication sent
                by first-class mail to a user's address in our records.
            </p>
            <p>
                <strong></strong>
            </p>
            <p>
                <strong>X. </strong>
                <strong>No Reliance on Information Posted</strong>
            </p>
            <p>
                ...
                and responsibility arising from any reliance placed on such information and
                materials by you, by any other user or visitor to the Sites, or by anyone
                who may be informed of any of its contents.
            </p>
            <p>
                The Sites may include content provided by third parties, including
                information or materials provided by other users, bloggers and third-party
                licensors, syndicators, aggregators and/or reporting services. All
                statements and/or opinions expressed in such information or materials, and
                all articles and responses to questions and other content, other than the
                responses or content provided by Cove, are solely the opinions and the
                responsibility of the individual or entity providing those materials. These
                materials do not necessarily reflect the opinion of Cove. Cove is not
                responsible, or liable to you or any third party, for the content or
                accuracy of any information or materials provided by any third parties.
            </p>
            <p>
                <strong>XI. </strong>
                <strong>Information About You and Your Visits to the Sites</strong>
            </p>
            <p>
                All information Cove collects on the Sites is subject to our Privacy
                Policy. By using the Sites, you consent to all actions taken by Cove with
                respect to your information in compliance with the Privacy Policy.
            </p>
            <p>
                <strong>XII. </strong>
                <strong>Linking to the Sites and Social Media Features</strong>
            </p>
            <p>
            You may link to Cove’s homepage, <a href="http://www.covesmart.com">www.covesmart.com</a>, provided you do
                so in a way that is fair and legal and does not damage Cove’s reputation or
                take advantage of it, but you must not establish a link in such a way as to
                suggest any form of association, approval or endorsement by Cove without
            ...
            <p>
                You may use these features only as they are provided to you by Cove and
                solely with respect to the content such features are displayed with, and
                otherwise in accordance with any additional terms and conditions Cove
                provides with respect to such features. Subject to the foregoing, you must
                not:
            </p>
            <ul>
              <li>
              ...
              <li>
                Cause the Sites or portions of the Sites to be displayed, or appear to be
                displayed by, for example, framing, deep linking or in-line linking, on any
                other Sites.
              </li>
              <li>
                Otherwise take any action with respect to the information or materials on
                the Sites that is inconsistent with any other provision of these Terms of
                Use.
              </li>
            </ul>
            <p>
                You agree to cooperate with Cove in causing any unauthorized framing or
                linking immediately to cease. We reserve the right to withdraw linking
                permission without notice.
            </p>
            <p>
                <strong>XIII. </strong>
                <strong>LINKS FROM THE SITES</strong>
            </p>
            <p>
                ...
                sponsored links. Cove has no control over the contents of those sites or
                ...
                third-party websites linked to the Sites, you do so entirely at your own
            ...
            <p>
                Cove, the owner of the Sites is based in the State of Utah, U.S.A. Cove
                provides the Sites for use only by persons located in the United States. We
                make no claims that the Sites or any of the content on the Sites is
                accessible or appropriate outside of the United States. Access to the Sites
                may not be legal by certain individuals or entities or in certain
                countries. If you access the Sites from outside the United States, you do
            ...
            <p>
                YOUR USE OF THE SITES, THEIR CONTENT AND ANY PRODUCTS, SERVICES,
                INFORMATION OR OTHER ITEMS OBTAINED THROUGH THE SITES IS AT YOUR OWN RISK.
                THE SITES, THEIR CONTENT AND ANY PRODUCTS, SERVICES, INFORMATION OR OTHER
                ITEMS OBTAINED THROUGH THE SITES ARE PROVIDED ON AN "AS IS" AND "AS
                AVAILABLE" BASIS, WITHOUT ANY WARRANTIES OF ANY KIND, EITHER EXPRESS OR
                IMPLIED. COVE DISCLAIMS ALL OTHER WARRANTIES, EXPRESS OR IMPLIED,
                INCLUDING, WITHOUT LIMITATION, IMPLIED WARRANTIES OF MERCHANTABILITY,
                FITNESS FOR A PARTICULAR PURPOSE, TITLE AND NON­INFRINGEMENT. YOU ARE
                SOLELY RESPONSIBLE FOR YOUR INTERACTIONS WITH OTHER USERS OF THE SITES.
                PRODUCT REVIEWS AND COMMENTS ARE STRICTLY THE OPINION OF THE USER POSTING
                SUCH REVIEWS OR COMMENTS, AND COVE DOES NOT ENDORSE OR APPROVE ANY SUCH
                REVIEWS OR COMMENTS. NEITHER COVE NOR ANY PERSON ASSOCIATED WITH COVE MAKES
                ANY WARRANTY OR REPRESENTATION WITH RESPECT TO THE COMPLETENESS, SECURITY,
                RELIABILITY, QUALITY, ACCURACY OR AVAILABILITY OF THE SITES. WITHOUT
                LIMITING THE FOREGOING, NEITHER COVE NOR ANYONE ASSOCIATED WITH COVE
                REPRESENTS OR WARRANTS THAT THE SITES, THEIR CONTENT AND ANY PRODUCTS,
                SERVICES, INFORMATION OR OTHER ITEMS OBTAINED THROUGH THE SITES WILL BE
                ACCURATE, RELIABLE, ERROR-FREE OR UNINTERRUPTED, THAT DEFECTS WILL BE
                CORRECTED, THAT THE SITES OR THE SERVER THAT MAKES THE SITES AVAILABLE ARE
                FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS OR THAT THE SITES OR ANY
                PRODUCTS, SERVICES, INFORMATION OR OTHER ITEMS OBTAINED THROUGH THE SITES
                WILL OTHERWISE MEET YOUR NEEDS OR EXPECTATIONS. COVE IS NOT RESPONSIBLE FOR
                TYPOGRAPHICAL ERRORS OR OMISSIONS RELATING TO PRICING, TEXT, OR
                PHOTOGRAPHY. WHILE COVE ATTEMPTS TO MAKE YOUR ACCESS AND USE OF THE SITES
                SAFE, WE CANNOT AND DO NOT REPRESENT OR WARRANT THAT THE SITES OR ITS
            ...
            <p>
                IN NO EVENT WILL COVE, ITS AFFILIATES OR THEIR RESPECTIVE LICENSORS,
                ...
                CONNECTION WITH YOUR USE, OR INABILITY TO USE, THE SITES, ANY WEBSITES
                LINKED TO THEM, ANY CONTENT ON THE SITES OR SUCH OTHER WEBSITES OR ANY
                PRODUCTS, SERVICES, INFORMATION OR OTHER ITEMS OBTAINED THROUGH THE SITES
                ...
                TO, PERSONAL INJURY, PAIN AND SUFFERING, EMOTIONAL DISTRESS, PROPERTY
                DAMAGE, LOSS OF REVENUE, LOSS OF PROFITS, LOSS OF BUSINESS OR ANTICIPATED
                ...
                FORESEEABLE. SOME STATES DO NOT ALLOW THE EXCLUSION OR LIMITATION OF
            ...
            <p>
                You agree to defend, indemnify and hold harmless Cove, its affiliates,
                licensors and service providers, and Cove’s and their respective officers,
                ...
                your use of the Sites, including, but not limited to, your User Posts, any
                use of the Sites' content, Services and Products other than as expressly
                authorized in these Terms of Use or Cove’s Terms of Sale, or your use of
                any information obtained from the Sites. THE FOREGOING INDEMNIFICATION
                OBLIGATIONS MAY NOT BE ENFORCEABLE IN SOME STATES, SO SUCH OBLIGATIONS MAY
                NOT APPLY TO YOU.
            </p>
            <p>
                <strong>XVIII. </strong>
            ...
            <p>
                ...
                the State of Utah, U.S.A., without reference to its conflicts of law rules.
                The interpretation of this Agreement shall not be construed against the
                drafter. You agree that any action at law or in equity arising out of or
                relating to these Terms of Use shall be filed only in the state and federal
                courts located in Salt Lake County, Utah and you hereby irrevocably and
                ...
                Use. TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, IF YOU OR COVE WANT
                TO ASSERT A DISPUTE AGAINST THE OTHER, THEN YOU OR COVE MUST COMMENCE IT
                (BY DELIVERY OF WRITTEN NOTICE AS SET FORTH IN SECTION XXI WITHIN 1 YEAR
                AFTER THE DISPUTE ARISES -- OR IT WILL BE FOREVER BARRED. DISPUTES AND
                CLAIMS ARISING UNDER THE TERMS OF SALE OR A RETAIL INSTALLMENT AGREEMENT
                (IF APPLICABLE) SHALL BE SUBJECT TO THE CORRESPONDING DISPUTE RESOLUTION
            ...
            <p>
                No waiver by Cove of any term or condition set forth in these Terms of Use
                shall be deemed a further or continuing waiver of such term or condition or
                a waiver of any other term or condition, and any failure of Cove to assert
                a right or provision under these Terms of Use shall not constitute a waiver
                of such right or provision. If any provision of these Terms of Use is held
                by a court or other tribunal of competent jurisdiction to be invalid,
                illegal or unenforceable for any reason, such provision shall be eliminated
                or limited to the minimum extent such that the remaining provisions of the
            ...
            <p>
                These Terms of Use, Cove’s Privacy Policy, and the Terms of Sale constitute
                the sole and entire agreement between you and Cove with respect to the
                Sites and supersede all prior and contemporaneous understandings,
                agreements, representations and warranties, both written and oral, with
                respect to your use of the Sites.
            </p>
            <p>
                For the avoidance of doubt, the Terms of Sale govern your purchase and use
                of any of Cove’s Products or Services you have selected to receive from
                Cove, including account information and account management. These Terms of
                Use are in addition to any such terms that may apply to you. Any conflicts
                between these Terms of Use and the Terms of Sale shall be superseded and
                governed by the Terms of Sale. Any claims and disputes arising under the
                Terms of Sale shall be subject solely to those terms and not these Terms of
                Use.
            </p>
            <p>
                <strong>XXI. </strong>
            ...
            <p>
                The Sites are operated by Cove Smart, LLC, 14015 Minuteman Drive, Draper,
                UT 84020.
            </p>
            <p>
                All written notices due or contemplated hereunder should be sent to the
                attention of the Legal Department as indicated below.
            </p>
            <p>
                Cove Smart, LLC
            </p>
            ...
            communications relating to the Sites should be directed to: <a href="mailto:support@covesmart.com">support@covesmart.com</a>
            </p>
            {/* PRIVACY POLICY */}
            <h1 id="privacyPolicy">COVE PRIVACY POLICY</h1>
            <p>
              <strong>Last Updated: 4/16/2018</strong>
            </p>
            <p>
            ...
            <p>
                <strong>
                    <u>
                        ...
                        COVE AT <a href="mailto:support@covesmart.com"><strong>SUPPORT@COVESMART.COM</strong></a>
                    </u>
                </strong>
            ...
            <p>
                ...
                at any time at <a href="http://www.covesmart.com/privacypolicy"> www.covesmart.com/privacypolicy</a>
