...
const Index = () => (
  <Layout>
      ...
      <Container>
        ...
        <div className={s.headerCenterText}>
          ...
          <Row className="align-items-end justify-content-center">
            <Col xs={6} className="mx-auto" style={{
              marginTop: '30px',
              position: 'relative',
              bottom: '18%',
            }}>
    ...
    <div className={s.stepsOuter}>
      <div className={s.stepsPhoto}><img src="/static/images/panelPhoto.png" className="img-fluid"/></div>
      <Container>
        ...
        <div className={s.testimonial}>
          <div className={s.testimonialBorder}></div>
      ...
      <Container>
        <div className={s.panelBanner}></div>
