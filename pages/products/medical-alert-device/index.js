            ...
            <Row className="no-gutter">
              <Col xs={{ size: 12, order: 2 }} sm={{ size: 6, order: 1 }}>
                <div className="product__column--large product__column--center product__column--no-pad-left">
                  ...
                  <p className="product__paragraph product__alt-font">Each medical alert is pre-coupled with your Cove Touch panel. With a couple touches of the screen to confirm each Medical sensor is setup and ready to protect.</p>
                </div>
              </Col>
