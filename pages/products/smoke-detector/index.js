          ...
          <Container>
            ...
            <Row>
              ...
              <Col xs={{ size: 12, order: 0 }} md={{ size: 4, order: 1 }}>
                <img className="product__showcase-image" alt="Smoke Detector Detector" src="/static/images/product/smoke-detector/smoke-detector-front.jpg" />
              </Col>
            ...
            <Row>
              ...
              <Col sm={6}>
                <img className="product__image-flex" alt="Smoke Detector Detector" src="/static/images/product/smoke-detector/smoke-detector-crop.jpg" />
              </Col>
            </Row>
            <Row>
              <Col sm={4}>
            ...
            <Row className="no-gutter">
              ...
              <Col xs={{ size: 12, order: 1 }} sm={{ size: 6, order: 2 }}>
                <div className="product__column--large product__column--dark">
                  <img className="product__column-image" src="/static/images/product/smoke-detector/smoke-detector-lifestyle.jpg" alt="Smoke Detector Detector Lifestyle" />
                </div>
              </Col>
            </Row>
            <div className="product__spacer" />
            ...
            <Row>
              <Col xs={12} sm={6}>
                <div className="product__column--large product__column--dark">
                  <img className="product__column-image" src="/static/images/product/cove-touch/cove-touch-square.jpg" alt="Smoke Detector Detector Lifestyle" />
                </div>
              </Col>
              <Col xs={12} sm={6}>
