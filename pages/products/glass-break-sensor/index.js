            ...
            <Row className="no-gutter">
              <Col xs={{ size: 12, order: 2 }} sm={{ size: 6, order: 1 }}>
                <div className="product__column--large product__column--center">
                  ...
                  <p className="product__text product__alt-font">Each glass sensor is pre-coupled with your Cove Touch panel. You can custom select each name to help you find its place in your home. With a couple touches of the screen you confirm each sensor is setup and ready to start protecting the ones you love.</p>
                </div>
              </Col>
