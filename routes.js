module.exports = () => {
  return {
    ...
    '/account/info/billdate': { page: '/account/info/billDate' },
    '/account/info/monitoredaddress': { page: '/account/info/monitoredAddress' },
    '/account/info/primaryphone': { page: '/account/info/primaryPhone' },
    '/account/info/secondaryphone': { page: '/account/info/secondaryPhone' },
    '/account/info/addemergencycontact': { page: '/account/info/addEmergencyContact' },
